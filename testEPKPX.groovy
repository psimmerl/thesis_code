...
def processors = [new epkpX()]


def proc_names = [data_prefix+"_epkpX_10gev_"+field_setting] //final_fx_epkpkm_combinatorics"+field_setting]
...
def outroot = new ROOTFile(data_prefix+"_epkpX_data_10gev_${outname}_"+field_setting+".root") //final_phi_analysis_fx_epkpkm_comb_$outname"+"_"+field_setting+".root")
