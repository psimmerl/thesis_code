...
def processors = [new ElectronMon(field_config: field_setting)]
...
timer.schedule({
    ...
    out.writeFile(data_prefix+"_elMon_"+field_setting+"$outname")
...
def outroot = new ROOTFile(data_prefix+"_elMon_$outname"+"_"+field_setting+".root")
