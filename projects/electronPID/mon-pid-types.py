...
if __name__ == '__main__':
    ...
    plot_overlap_1d( can, histos_eb, histos_mod, 'p_ele_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, P_{e} Final #phi (FD) Events' , xtitle='P_{el} (GeV)', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'theta_ele_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #Theta_{e} Final #phi (FD) Events' , xtitle='#Theta_{el} (deg)', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'phi_ele_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #Phi_{e} Final #phi (FD) Events' , xtitle='#Phi_{el} (deg)', ytitle='counts', logy=True, set_marker_style=True)
    #proton
    plot_overlap_1d( can, histos_eb, histos_mod, 'p_pro_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, P_{p} Final #phi (FD) Events' , xtitle='P_{p} (GeV)', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'theta_pro_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #Theta_{p} Final #phi (FD) Events' , xtitle='#Theta_{p} (deg)', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'phi_pro_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #Phi_{p} Final #phi (FD) Events' , xtitle='#Phi_{p} (deg)', ytitle='counts', logy=True, set_marker_style=True)
    #kaonsP
    plot_overlap_1d( can, histos_eb, histos_mod, 'p_kp_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, P_{K^{+}} Final #phi (FD) Events' , xtitle='P_{K^{+}} (GeV)', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'theta_kp_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #Theta_{K^{+}} Final #phi (FD) Events' , xtitle='#Theta_{K^{+}} (deg)', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'phi_kp_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #Phi_{K^{+}} Final #phi (FD) Events' , xtitle='#Phi_{K^{+}} (deg)', ytitle='counts', logy=True, set_marker_style=True)
    ...
    plot_overlap_1d( can, histos_eb, histos_mod, 'im_kpkm_pass_all', output_pdfname, lab, 
                     title='REC EB vs ModPID, I.M. K^{+}K^{-} Final #phi (FD)' , xtitle='I.M. K^{+}K^{-} (GeV)', ytitle='counts', logy=True, set_marker_style=True)
    
    ##### now look at q2, xb, -t
    plot_overlap_1d( can, histos_eb, histos_mod, 'q2_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, Q^{2} Final #phi (FD) Events' , xtitle='#Q^{2} (GeV^{2})', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 't_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, -t Final #phi (FD) Events' , xtitle='-t (GeV^{2})', ytitle='counts', logy=True, set_marker_style=True)
    
    plot_overlap_1d( can, histos_eb, histos_mod, 'xb_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, X_{b} Final #phi (FD) Events' , xtitle='X_{b}', ytitle='counts', logy=True, set_marker_style=True)

    plot_overlap_1d( can, histos_eb, histos_mod, 'phitrento_small_pass_all_cut_phi_mass', output_pdfname, lab, 
                     title='REC EB vs ModPID, #phi_{Trento} Final #phi (FD) Events' , xtitle='#phi_{trento} (deg)', ytitle='counts', logy=True, set_marker_style=True)
