...
if __name__ == '__main__':
    ...
    #electron
    plot_overlap_1d( can, histos_data1, histos_data2, 'mass_small_bin', output_pdfname, lab, 
                     title='REC Data1 vs Data2, Phi Mass' , xtitle='K^{ +}K^{ -} (GeV)', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 'trento', output_pdfname, lab, 
                     title='REC Data1 vs Data2, trento' , xtitle='#phi_{Trento} (deg)', ytitle='counts', set_marker_style=True, scale=True)
    plot_overlap_1d( can, histos_data1, histos_data2, 'trento_pos', output_pdfname, lab, 
                     title='REC Data1 vs Data2, trento P' , xtitle='#phi_{Trento} (deg)', ytitle='counts', set_marker_style=True, scale=True)
    plot_overlap_1d( can, histos_data1, histos_data2, 'trento_neg', output_pdfname, lab, 
                     title='REC Data1 vs Data2, trento N' , xtitle='#phi_{Trento} (deg)', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 't_pos', output_pdfname, lab, 
                     title='REC Data1 vs Data2, t pos' , xtitle='-t (GeV^{2})', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 't_neg', output_pdfname, lab, 
                     title='REC Data1 vs Data2, t neg' , xtitle='-t (GeV^{2})', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 'xb_bin_1_mass_small_bin', output_pdfname, lab, 
                     title='REC Data1 vs Data2, X_{B} Bin1' , xtitle='X_{B}', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 'xb_bin_2_mass_small_bin', output_pdfname, lab, 
                     title='REC Data1 vs Data2, X_{B} Bin2' , xtitle='X_{B}', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 'q2_bin_1_mass_small_bin', output_pdfname, lab, 
                     title='REC Data1 vs Data2, Q^{2} Bin1' , xtitle='Q^{2} (GeV^{2})', ytitle='counts', set_marker_style=True, scale=True)

    plot_overlap_1d( can, histos_data1, histos_data2, 'q2_bin_2_mass_small_bin', output_pdfname, lab, 
                     title='REC Data1 vs Data2, Q^{2} Bin2' , xtitle='Q^{2} (GeV^{2})', ytitle='counts', set_marker_style=True, scale=True)
