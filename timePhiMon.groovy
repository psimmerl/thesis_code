...
def processors = [new TimingPhiEventMon(field_config: field_setting)]
...
timer.schedule({
    ...
    out.writeFile(data_prefix+"_elTimingPhiMon_"+field_setting+"$outname")
...
def outroot = new ROOTFile(data_prefix+"_elTimingPhiMon_$outname"+"_"+field_setting+".root")
